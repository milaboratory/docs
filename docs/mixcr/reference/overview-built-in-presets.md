...
·
[:octicons-link-16: Link](https://www.thermofisher.com/order/catalog/product/A35386)
·
[:octicons-mark-github-16: Code](https://github.com/milaboratory/mixcr/blob/develop/src/main/resources/mixcr_presets/protocols/thermofisher.yaml)

The Oncomine™ TCR Beta‑LR Assay is a highly sensitive, RNA-based NGS assay that enables the
characterization of the T-cell receptor β (TCRβ) sequences, including all complementarity-determining
regions (CDR1, 2, and 3) of the variable gene. The assay accurately measures T‑cell repertoire diversity,
clonal expansion, and allows for identification of allele-specific polymorphisms, in a wide array of
sample types.

![](pics/oncomine-human-tcrb-lr-light.svg#only-light)
![](pics/oncomine-human-tcrb-lr-dark.svg#only-dark)
...
·
[:octicons-link-16: Link](https://www.thermofisher.com/order/catalog/product/A39072)
·
[:octicons-mark-github-16: Code](https://github.com/milaboratory/mixcr/blob/develop/src/main/resources/mixcr_presets/protocols/thermofisher.yaml)

The Oncomine™ TCR Beta‑SR Assay is a highly sensitive RNA- or DNA-based NGS assay that enables
the characterization of the T-cell receptor β (TCRβ) complementarity-determining region 3 (CDR3)
sequences of the TCRβ chain. The assay accurately measures T‑cell repertoire diversity and clonal
expansion in a wide array of sample types, including those derived from FFPE-preserved or degraded
material.

![](pics/oncomine-human-tcrb-sr-light.svg#only-light)
![](pics/oncomine-human-tcrb-sr-dark.svg#only-dark)
...
·
[:octicons-link-16: Link](https://www.thermofisher.com/order/catalog/product/A45485)
·
[:octicons-mark-github-16: Code](https://github.com/milaboratory/mixcr/blob/develop/src/main/resources/mixcr_presets/protocols/thermofisher.yaml)

The Oncomine™ BCR IGH‑LR Assay is a highly sensitive, RNA-based NGS assay that enables the
characterization of immunoglobulin heavy-chain sequences, including all complementarity-determining
regions (CDR1, 2, and 3) and the CH1 domain of the constant gene. The assay accurately measures
repertoire diversity, clonal expansion, allows for determination of B cell isotype (and subtype), and
reports the level of somatic hypermutation, in a wide array of sample types

![](pics/oncomine-human-bcr-ihg-lr-light.svg#only-light)
![](pics/oncomine-human-bcr-ihg-lr-dark.svg#only-dark)
...
·
[:octicons-link-16: Link](https://www.thermofisher.com/order/catalog/product/A45483)
·
[:octicons-mark-github-16: Code](https://github.com/milaboratory/mixcr/blob/develop/src/main/resources/mixcr_presets/protocols/thermofisher.yaml)

The Oncomine™ BCR IGH‑SR Assay is a highly sensitive RNA- or DNA-based NGS assay that enables
the characterization of the immunoglobulin heavy chain complementarity-determining region 3 (CDR3)
sequences. The assay accurately measures B cell repertoire diversity and clonal expansion in a wide
array of sample types, including samples derived from FFPE-preserved or degraded material


![](pics/oncomine-human-bcr-ihg-sr-light.svg#only-light)
![](pics/oncomine-human-bcr-ihg-sr-dark.svg#only-dark)
...
·
[:octicons-link-16: Link](https://www.thermofisher.com/order/catalog/product/A51559)
·
[:octicons-mark-github-16: Code](https://github.com/milaboratory/mixcr/blob/develop/src/main/resources/mixcr_presets/protocols/thermofisher.yaml)

The Oncomine™ BCR Pan-Clonality Assay is a highly sensitive, single reaction, DNA-based NGS assay
that enables the characterization of B cell heavy chain (IGH) and light chain (IgK and IgL) receptor
sequences, including each complementarity-determining region 3 (CDR3). The assay accurately
measures B cell repertoire metrics such as repertoire diversity and clonality in multiple receptors in
a single reaction.

![](pics/oncomine-human-bcr-pan-clonality-light.svg#only-light)
![](pics/oncomine-human-bcr-pan-clonality-dark.svg#only-dark)
...
·
[:octicons-link-16: Link](https://www.thermofisher.com/order/catalog/product/A51560)
·
[:octicons-mark-github-16: Code](https://github.com/milaboratory/mixcr/blob/develop/src/main/resources/mixcr_presets/protocols/thermofisher.yaml)
...
![](pics/oncomine-human-igh-fr3-j-light.svg#only-light)
![](pics/oncomine-human-igh-fr3-j-dark.svg#only-dark)
...
·
[:octicons-link-16: Link](https://www.thermofisher.com/order/catalog/product/A51561)
·
[:octicons-mark-github-16: Code](https://github.com/milaboratory/mixcr/blob/develop/src/main/resources/mixcr_presets/protocols/thermofisher.yaml)

Oncomine™ IGH FR2-J Assay is a highly sensitive, DNA-based NGS assays that enable the characterization of B cell heavy chain (IGH) sequences, including complementarity-determining region 3 (CDR3). The assays accurately measure B cell repertoire metrics such as repertoire diversity and clonality. The Oncomine™ IGH FR2-J Assay uses multiplex Ion AmpliSeq™ primers to target the FR2 region of the variable gene and
the joining gene segment of IGH rearrangements in genomic DNA producing 200–250 bp amplicons.
Note, that clonotypes in this preset are assembled by `{CDR2Begin:CDR3End}` feature, because primers are located in FR2 and FR4.

![](pics/oncomine-human-igh-fr2-j-light.svg#only-light)
![](pics/oncomine-human-igh-fr2-j-dark.svg#only-dark)
...
·
[:octicons-link-16: Link](https://www.thermofisher.com/order/catalog/product/A51564)
·
[:octicons-mark-github-16: Code](https://github.com/milaboratory/mixcr/blob/develop/src/main/resources/mixcr_presets/protocols/thermofisher.yaml)
...
Note, that clonotypes in this preset are assembled by `{CDR1Begin:CDR3End}` feature, because primers are located in FR1 and FR4.

![](pics/oncomine-human-igh-fr1-j-light.svg#only-light)
![](pics/oncomine-human-igh-fr1-j-dark.svg#only-dark)
...
·
[:octicons-link-16: Link](https://www.thermofisher.com/order/catalog/product/A51563)
·
[:octicons-mark-github-16: Code](https://github.com/milaboratory/mixcr/blob/develop/src/main/resources/mixcr_presets/protocols/thermofisher.yaml)
...
Note, that clonotypes in this preset are assembled by `{FR1Begin:CDR3End}` feature, because primers are located in the leader sequence and FR4.


![](pics/oncomine-human-igh-leader-j-light.svg#only-light)
![](pics/oncomine-human-igh-leader-j-dark.svg#only-dark)
...
·
[:octicons-link-16: Link](https://www.thermofisher.com/order/catalog/product/A51562)
·
[:octicons-mark-github-16: Code](https://github.com/milaboratory/mixcr/blob/develop/src/main/resources/mixcr_presets/protocols/thermofisher.yaml)
...
![](pics/oncomine-human-tcr-pan-clonality-light.svg#only-light)
![](pics/oncomine-human-tcr-pan-clonality-dark.svg#only-dark)
